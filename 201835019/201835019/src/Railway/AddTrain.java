...
{
        try {
            pst = (PreparedStatement) con.prepareStatement("select * from train_details");
            rs = pst.executeQuery();
    ...
    private void initComponents() {
        ...
        tsstartplace = new javax.swing.JTextField();
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtno)
                    .addComponent(tname)
                    .addComponent(tsstartplace)
                    .addComponent(tdplace, javax.swing.GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(tsstartplace, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String splace = tsstartplace.getText();
        String dplace = tdplace.getText();
        String price = txtprice.getText();
        
        
        try {
            pst = (PreparedStatement) con.prepareStatement("insert into train_details(tno,tname,startplace,destinationplace,price)values(?,?,?,?,?)");
            pst.setString(1, tno);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        tsstartplace.setText(d.getValueAt(selectIndex, 2).toString());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            pst = (PreparedStatement) con.prepareStatement("update train_details set tname = ?, destinationplace = ?, startplace = ?, price= ?, where tno = ? ");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            pst = (PreparedStatement) con.prepareStatement("delete from train_details where tno = ? ");
            pst.setString(1, tno);
    ...
    private javax.swing.JTextField tsstartplace;
